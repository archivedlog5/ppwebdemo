...
router.get('/applepay-ecs', (req, res) => {
  ...
  res.render('paypal/jssdk-v5/applepay-ecs', {
    ...
    const body = {
      ...
      payment_source: {
        apple_pay: {
          ...
          experience_context: {
            return_url: `${req.protocol}://${req.get('host')}/paypal/jssdk-v5/applepay-ecs`,
            cancel_url: `${req.protocol}://${req.get('host')}/paypal/jssdk-v5/applepay-ecs`,
          },
        },
      },
    }
