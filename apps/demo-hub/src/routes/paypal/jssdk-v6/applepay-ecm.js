...
router.get('/applepay-ecm', (req, res) => {
  ...
  res.render('paypal/jssdk-v6/applepay-ecm', {
  ...
  try {
    ...
    const body = {
      ...
      payment_source: {
        apple_pay: {
          experience_context: {
            return_url: `${req.protocol}://${req.get('host')}/paypal/jssdk-v6/applepay-ecm`,
            cancel_url: `${req.protocol}://${req.get('host')}/paypal/jssdk-v6/applepay-ecm`,
          },
        },
      },
    }
